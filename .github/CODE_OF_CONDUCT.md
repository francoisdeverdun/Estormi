...
reported privately to the project maintainers through GitHub's **Private
Vulnerability Reporting** flow on the repository's Security tab (the same
channel described in [SECURITY.md](SECURITY.md)). All complaints will be
reviewed and investigated promptly and fairly. All maintainers are obligated
